function About() {
  return (
    <div >
      ...
      <p>This project was done in collaboration between Neil Chanez, Yuxiang (Sean) Li and Jacob Nasrallah. We wanted to demonstrate the use of React, Javascript, and CSS styling with Bootstrap 5.</p>
      <div className="">
        <h1 className="lead">Neil Chanez</h1>
        <div className="justify-content-between">
          <img src="./images/Neil.jpg" width="350px" height="350px" alt="Neil" />
          <p className="mt-4">Located in Los Angeles, California. You can find me at: <ul className="list-inline"><li><a href="https://github.com/Chanez89">GitHub</a> </li><li><a href="https://www.linkedin.com/in/neil-chanez-gracia-04743b18/">LinkedIn</a></li></ul></p>
        </div>
        <h1 className="lead">Yuxiang (Sean) Li</h1>
        <div className="justify-content-between">
          <img src="./images/yuxiang(sean)_li.png" width="40%" height="40%" alt="Yuxiang-Sean" />
        ...
        <div className=" justify-content-between">
          <img src="./images/jacobpfp.jpeg" alt="Jacob" />
